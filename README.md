...
[Install](#install-in-60-seconds) · [See it work](#see-it-work) · [What it reaches](#what-your-agent-can-reach) · [Files to markdown](#any-file-becomes-markdown) · [Library](#embed-it-as-a-typescript-library) · [All 204 commands](docs/COMMANDS.md)
...
| `run-command` | The 200 **read** commands. `readOnlyHint: true`, so clients can auto-approve it. |
...
- **[All 204 commands](docs/COMMANDS.md)**: per-category tables with required params + Graph endpoint
