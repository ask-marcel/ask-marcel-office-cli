...
| Cold-start reduction (lazier imports / precompiled registry) | I | QA-012 | open (~0.9 s node / ~0.65 s bun 2026-06-16 — stable vs 06-15, not eliminated) |
