...
| Friction-plan #3 — headless auth fail-fast (non-interactive mode → instant "run login" instead of a browser hang) | I | friction-plan 2026-06-16 | NOT SELECTED (touches auth; E-01 already covers the on-display case) — open if a server/CI MCP needs it |
